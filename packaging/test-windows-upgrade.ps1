...
if ([System.IO.Path]::GetFileName($CandidateInstaller) -notmatch "0\.12\.1") {
    throw "The candidate installer is not the expected 0.12.1 build."
}
...
Write-Host "Windows 0.10.0 to 0.12.1 upgrade validation passed."
