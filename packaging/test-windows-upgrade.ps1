...
if ([System.IO.Path]::GetFileName($CandidateInstaller) -notmatch "0\.13\.0") {
    throw "The candidate installer is not the expected 0.13.0 build."
}
...
Write-Host "Windows 0.10.0 to 0.13.0 upgrade validation passed."
