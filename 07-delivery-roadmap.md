...
当前进度：六部分全部完成，包含界面基础、Tauri 原生外壳、私有 sidecar、真实
任务写操作、自动化前端旅程、Codex 登录、原生仓库选择、后台完成协调、重启
恢复、持久化任务详情、维护入口和 Windows 本地通知。

- [x] 首次启动、Codex 登录和项目选择；
- [x] 任务创建、状态、进度和控制；
- [x] 审批中心；
- [x] 活动、运行、检查点、验收证据和报告；
- [x] 备份恢复、设置和本地通知；
